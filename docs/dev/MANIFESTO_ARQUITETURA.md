...
- Agent Builder principal: `agent_1777236402725` (motor único Gemini 2.5 Pro — Líder Supremo)
...
gs://datalake-tbr-raw/
   ...
   └─ 5% alto risco → Vertex AI Gemini 2.5 Pro (Líder Supremo) → laudo PDF → gs://datalake-tbr-clean/reports/
