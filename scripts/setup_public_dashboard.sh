...
echo ""
echo "🌐 CORS para fetch() no browser (painel → ranking.json):"
echo "   A partir da raiz do repo:"
echo "   gcloud storage buckets update gs://$BUCKET --cors-file=scripts/gcs-cors-tbr-public-dashboard.json"
echo ""
echo "Teste:"
