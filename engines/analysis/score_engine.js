 ...
 *   score ≥ 85  → Vertex Gemini 2.5 Pro (G.O.A.T.: alinhado ao Líder Supremo agent_1777236402725), hard cap US$ 95/mês
 *
...
// ---------------------------------------------------------------------------
// callVertex — chama Gemini 2.5 Pro via Vertex AI REST (ADC); motor único Líder Supremo agent_1777236402725.
...
export async function callVertex(payload) {
  ...
  const systemInstruction = (
    'Você é o motor Gemini 2.5 Pro do Líder Supremo (Agent ID agent_1777236402725). ' +
