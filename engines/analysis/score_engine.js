...
/** ID do Agent Builder — único motor IA autorizado (G.O.A.T. Pilar 1). */
...
// ---------------------------------------------------------------------------
// callVertex — chama Gemini 2.5 Pro via Vertex AI REST (ADC), alinhado ao Líder Supremo
...
export async function callVertex(payload) {
  ...
  // Estima custo (ajustar pricing se Vertex atualizar tarifas do modelo em uso)
