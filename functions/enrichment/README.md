...
2. Configurar segredos (`BUREAU_API_KEY`, `BUREAU_API_KEY_QUOD`, `TELEGRAM_BOT_TOKEN`, …) e variáveis (`BUREAU_HTTP_BASE_URL`, `BUREAU_PROVIDER`, `BUDGET_DIARIO_BRL`, `TELEGRAM_ALERT_CHAT_ID`, `DATAPREV_ENABLED`).
