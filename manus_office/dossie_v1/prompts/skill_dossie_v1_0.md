...
**Token Direct Data do Comandante:** `29AE5E97-AACF-4ACC-B0ED-692472D72D60`
...
Template:
```bash
curl -s "https://apiv3.directd.com.br/api/ReceitaFederalPessoaJuridica?CNPJ=${cnpj}&TOKEN=29AE5E97-AACF-4ACC-B0ED-692472D72D60" > "qsa_${cnpj}.json"
```
