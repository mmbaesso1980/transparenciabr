...
app.post('/', verifyOidcJwt, async (req, res) => {
  ...
  const prompt = [
    `Vertex Reasoning Engine is the Líder Supremo deployment (Agent Builder ID ${SUPREME_AGENT_BUILDER_ID}); worker shard label: ${agent_id}. Correlation ID: ${correlationId}.`,
